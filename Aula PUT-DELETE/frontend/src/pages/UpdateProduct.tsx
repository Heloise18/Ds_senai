...
export const UpdateProduct = () => {
    ...
    const getProductData = async () => {
        ...
        const tralalala = response.data.response

        setName(tralalala.name)
        setCategory(tralalala.category)
        setPrice(tralalala.price)
        setStock(tralalala.stock)
        setDescription(tralalala.description)
    }
