...
class PersonController {
    ...
    static async postUser(req: Request, res: Response){
        ...
        const person = new Product({name, lastname, age})
    ...
    static async putUSer(req: Request, res: Response){
        ...
        try {  
            const person = await Product.findByIdAndUpdate(id , {name, lastname, age})
    ...
    static async deleteUser(req: Request, res: Response){
        ...
        try {
            const person = await Product.findByIdAndDelete(id);
